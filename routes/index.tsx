  ...
  return (
    <div class={tw`p-4 mx-auto max-w-screen-md`}>
      ...
      <div class = {tw`mt-6 w-full`}>
        <div class = {tw`mx-auto text-center bg-gray-900 text-white p-1`} onCopy = {e => e.clipboardData?.setData("text/plain", "https://count.nekooftheabyss.moe/get/CUSTOM_NAME/img") }>https://count.nekooftheabyss.moe/get/CUSTOM_NAME/img</div>
      </div>
    </div>
  );
}
